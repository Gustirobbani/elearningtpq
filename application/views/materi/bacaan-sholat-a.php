...
<body style="overflow-x:hidden;background-color:#fbf9fa">
    ...
    <div class="container" style="border: 2px solid orange;">
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:30px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    ...
                    <h4 data-aos="fade-down" data-aos-duration="1700"><?php
                            ...
                            echo $data['user']['nama'];
                            ?> - TPQ Muslimat Al-Quthhubi</h4>
                    <p>Materi Bacaan Sholat Kelas A</p>
                    <hr width="80%">
