        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    <h1 class="display-4" data-aos="fade-down" data-aos-duration="1400"> Review Hafalan Oleh Ustadz
                    </h1>
        ...
        <div class="col-md-12 mb-4">
            <div class="card materi border-0">
                <div class="card-body p-5">
                    <h1 class="card-title display-4" style="font-size: 40px; width: 80%; margin-right: 30%;">Hafalan: <?= $user['nama']; ?></h1>
                    <!-- Menampilkan komentar yang sudah ada -->
                    <?php foreach ($komentar as $k): ?>
                        <?php if ($k->nama === $user['nama']) : ?>
                            <p style="font-size: 25px; font-weight: bold; width: 80%;">
                                <?php echo "Surat " . $k->nama_hafalan; ?> : <?php echo $k->komen; ?>
                            </p>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </div>
