        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    ...
                    <p>Hafalan Kelas A</p>
                    <hr width="80%">
                    <p data-aos="fade-down" class="font-weight-bold" data-aos-duration="1800">Ustadz akan mengkoreksi hafalan
                    </p>
                </div>
            </div>
        </div>
...
<div class="form-container">
    <form action="<?= base_url('upload/do_upload') ?>" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        <div class="form-group">
            <label for="inputState" style="font-weight: bold;">Nama hafalan</label>
            <select required id="inputState" name="nama_hafalan" class="form-control">
                <option selected>Pilih disini</option>
                <option value="An - Naba">An - Naba</option>
                <option value="An - Naziat">An - Naziat</option>
                <option value="Abassa">Abassa</option>
                <option value="At - Takwir">At-takwir</option>
                <option value="Al - infithar">Al-infithar</option>
            </select>
        </div>
...
function validateForm() {
    ...
    var allowedExtensions = /(\.mp4|\.avi|\.mov)$/i; // Add more video extensions if necessary

    if (!allowedExtensions.exec(file.name)) {
        alert('Hanya file video dengan ekstensi .mp4, .avi, atau .mov yang diperbolehkan.');
        return false;
    }
