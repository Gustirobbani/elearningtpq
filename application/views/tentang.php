                ...
                <div class="accordion" id="accordionExample">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body">
							Menjadi pusat pembelajaran Al-Qur'an yang unggul dan berintegritas, membentuk generasi yang mencintai dan mengamalkan Al-Qur'an, serta berkontribusi positif dalam masyarakat.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
							Menciptakan lingkungan belajar yang inspiratif: TPQ memiliki misi untuk menciptakan lingkungan belajar yang inspiratif dan kondusif bagi siswa. Misi ini meliputi penggunaan metode pengajaran yang inovatif, penggunaan materi pembelajaran yang menarik, dan memastikan adanya suasana yang positif dan inklusif di dalam TPQ.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                            <div class="card-body">
							Membentuk karakter yang berlandaskan ajaran Al-Qur'an: TPQ memiliki misi untuk membentuk karakter siswa yang berlandaskan pada ajaran Al-Qur'an. Misi ini meliputi pengembangan akhlak mulia, nilai-nilai kebaikan, integritas, dan etika yang baik dalam kehidupan sehari-hari.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordionExample">
                            <div class="card-body">
							Pembentukan Karakter yang Kuat: Melalui nilai-nilai Islam yang diajarkan di TPQ Muslimat Al-Quthubi, seperti kejujuran, kesabaran, dan kasih sayang, TPQ membantu dalam pembentukan karakter yang kuat pada siswa. Mereka belajar untuk menjadi individu yang berakhlak mulia dan berintegritas.
                            </div>
                        </div>
                    </div>
                </div>
