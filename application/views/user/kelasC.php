...
<body style="overflow-x:hidden;background-color:#fbf9fa">
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    ...
                    <p>Hello Santri , Ini merupakan halaman mapel di TPQ Muslimat Al-Quthubi ! Silahkan pilih mapel yang akan kamu
                        akses
    ...
    <div class="container">
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?= base_url('materi/risalatul_awal_c') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/Risalatul Awal.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?= base_url('materi/aqidah_ahlak_c') ?>">
                    <div class="card-kelas">
            ...
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                <a href="<?= base_url('materi/ilmu_tajwid_c') ?>">
                    <div class="card-kelas">
    ...
    <div class="container">
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?= base_url('materi/surah_pendek_c') ?>">
                    <div class="card-kelas">
            ...
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?= base_url('materi/hafalan_c') ?>">
                    <div class="card-kelas">
            ...
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                <a href="<?= base_url('materi/komentar_c') ?>">
                    <div class="card-kelas">
