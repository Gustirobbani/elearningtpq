...
<body style="overflow-x:hidden;background-color:#fbf9fa">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            <li class="nav-item "><a class="nav-link" href="javascript:void(0) ">Hai, </a>
                            </li>
    ...
    <div class="container">
        <div class="row mt-4 mb-5 justify-content-center">
            <div class="col-md-12">
                <div class="row">
				<?php if($this->session->userdata('access')=='x'){ ?>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900" data-aos="fade-right">
                        <a href="<?= base_url('user/kelasA') ?>">
                            <div class="card-kelas text-center">
                                <img src="<?= base_url('assets/') ?>img/Kelas A.png" style="object-fit: cover;" class="card-img-top img-fluid" alt="...">
                            </div>
                        </a>
                    </div>
					<?php }if($this->session->userdata('access')=='xi'){ ?>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900" data-aos="fade-down">
                        <a href="<?= base_url('user/kelasB') ?>">
                            <div class="card-kelas">
                                <img src="<?= base_url('assets/') ?>img/Kelas B.png" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
					<?php }if($this->session->userdata('access')=='xii'){ ?>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                        <a href="<?= base_url('user/kelasC') ?>">
                            <div class="card-kelas">
                                <img src="<?= base_url('assets/') ?>img/Kelas C.png" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
					<?php }; ?>
