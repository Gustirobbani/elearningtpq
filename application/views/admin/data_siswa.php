        ...
        <div class="sidebar-brand text-danger">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Santri</h2>
                            <hr>
                            <p class="card-text"> Manajemen data santri adalah proses mengumpulkan, menyimpan, mengelola, dan menggunakan informasi terkait siswa dalam konteks pendidikan. Tujuan utama manajemen data santri adalah memastikan keakuratan, keterjangkauan, dan keteraturan data santri  </p>
