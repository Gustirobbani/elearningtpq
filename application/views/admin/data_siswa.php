                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <p class="card-text"> Manajemen data siswa adalah proses mengumpulkan, menyimpan, mengelola, dan menggunakan informasi terkait siswa dalam konteks pendidikan. Tujuan utama manajemen data siswa adalah memastikan keakuratan, keterjangkauan, dan keteraturan data siswa  </p>
