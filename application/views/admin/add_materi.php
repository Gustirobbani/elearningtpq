                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('admin/') ?>">Tambah Data Guru</a>
                                </li>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Silahkan jika ingin menambahkan materi yang sudah di berikan oleh guru terkait
                                </p>
